        ...
        <div className="flex flex-col md:flex-row justify-between gap-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:w-2/3">
            <div className="border-l border-gray-700 pl-4">
              <h3 className="font-semibold mb-3 text-lg text-teal-400">Services</h3>
            ...
            <div className="border-l border-gray-700 pl-4">
              <h3 className="font-semibold mb-3 text-lg text-teal-400">Company</h3>
              <ul className="space-y-2">
                <li>
                  <Link href="#" className="text-gray-300 hover:text-teal-400 transition-colors duration-300">
                    About Us
            ...
            <div className="border-l border-gray-700 pl-4">
              <h3 className="font-semibold mb-3 text-lg text-teal-400">Support</h3>
              <ul className="space-y-2">
                <li>
                  <Link href="#" className="text-gray-300 hover:text-teal-400 transition-colors duration-300">
                    Help Center
                ...
                <li>
                  <Link href="/tracking" className="text-gray-300 hover:text-teal-400 transition-colors duration-300">
                    Track Shipment
                  </Link>
                </li>
                <li>
